  ...
  return (
    <IonContent className="terms_page">
      ...
      <h4>
        ...
        https://triventure.in/ (the "Site"). This page informs you of our
        ...
        with this policy. Information Collection And Use While using our Site,
        ...
        ("Personal Information"). Log Data Like many site operators, we collect
        information that your browser sends whenever you visit our Site ("Log
        ...
        analyze this … The Log Data section is for businesses that use analytics
        or tracking services in websites or apps, like Google Analytics. For the
        full disclosure section, create your own Privacy Policy. Communications
        ...
        cookies, you may not be able to use some portions of our Site. Security
        ...
        us, or by placing a prominent notice on our website. Contact Us If you
