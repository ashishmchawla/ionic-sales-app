  ...
  return (
    <IonContent className="terms_page">
      ...
      <h4>
        ...
        Service or parts of our Service. <br />● “Company” (referred to as
        either "the Company", "We", "Us" or "Our" in this Agreement).
        <br /> ● “Country” refers to Triventure Advisory Pvt. Ltd.
        <br /> ● “Content” refers to content such as text, images, or other
        information that can be posted, uploaded, linked to or otherwise made
        available by You, regardless of the form of that content. <br />●
        “Device” means any device that can access the Service such as a
        computer, a cell phone or a digital tablet. <br />● “Feedback” means
        feedback, innovations or suggestions sent by You regarding the
        attributes, performance or features of our Service. <br />● “Service”
        refers to the Website. <br />● “Terms and Conditions” (also referred as
        ...
        and Conditions Agreement was generated by TermsFeed Mobile App Terms and
        Conditions Generator. <br />● “Third-party Social Media Service” means
        ...
        made available by the Service. <br />● “Website” refers to Triventure
        Website, accessible from https://triventure.in <br />● “You” means the
        ...
        the Service, as applicable. Acknowledgment These are the Terms and
        ...
        Privacy Policy carefully before using Our Service. User Accounts When
        ...
        is otherwise offensive, vulgar or obscene. Content Your Right to Post
        Content Our Service allows You to post Content. You are responsible for
        the Content that You post to the Service, including its legality,
        reliability, and appropriateness. By posting Content to the Service, You
        ...
        Content Restrictions The Company is not responsible for the content of
        ...
        Your account. You may not transmit any Content that is unlawful,
        ...
        <br />● Unlawful or promoting unlawful activity.
        <br /> ● Defamatory, discriminatory, or mean-spirited content, including
        ...
        and its original content (excluding Content provided by You or other
        ...
        Company. Your Feedback to Us You assign all rights, title and interest
        in any Feedback You provide the Company. If for any reason such
